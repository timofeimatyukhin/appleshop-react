...
export const CardsBlock = () => {
    const cards = [
      {
        imagePath: "../public/Images/iphone17.jpg",
        title: (
          <>
        ...
        description:
          "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni illo est vero delectus magnam \
            asperiores deserunt maiores. Quo rem placeat molestiae nesciunt odio explicabo hic incidunt, cumque,\
            atque obcaecati dolores.",
        cost: "From $1099 or $45.79/mo. for 24 mo.*",
      },
      {
        imagePath: "../public/Images/iphone17air.jpg",
        title: "iPhone Air",
        description:
          "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni illo est vero delectus magnam \
            asperiores deserunt maiores. Quo rem placeat molestiae nesciunt odio explicabo hic incidunt, cumque,\
      ...
      {
        imagePath: "../public/Images/iphone17basic.jpg",
        title: "iPhone 17",
        description:
          "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni illo est vero delectus magnam \
            asperiores deserunt maiores. Quo rem placeat molestiae nesciunt odio explicabo hic incidunt, cumque,\
      ...
      {
        imagePath: "../public/Images/iphone16plus.jpg",
        title: (
          <>
        ...
        description:
          "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni illo est vero delectus magnam \
            asperiores deserunt maiores. Quo rem placeat molestiae nesciunt odio explicabo hic incidunt, cumque,\
            atque obcaecati dolores.",
        cost: "From $699 or $29.12/mo. for 24 mo.*",
      },
      {
        imagePath: "../public/Images/iphone16e.jpg",
        title: "iPhone 16e",
        description:
          "Lorem, ipsum dolor sit amet consectetur adipisicing elit. Magni illo est vero delectus magnam \
            asperiores deserunt maiores. Quo rem placeat molestiae nesciunt odio explicabo hic incidunt, cumque,\
            atque obcaecati dolores.",
        cost: "From $599 or $24.95/mo. for 24 mo.*",
      },
    ];
    return <ul className={styles.cardsList}>
        ...
        {cards.map((card, index) => (
            <Card key={index} id={index + 1} {...card} />
        ))}
    </ul>;
};
